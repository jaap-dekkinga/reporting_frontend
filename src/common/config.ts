...
export const AWS_COGNITO_PUBLIC_KEY_LINK = addrTemplate
  .replace("{#0#}", region)
  .replace("{#1#}", poolID);
...
const redirectURI = devMode
  ? "http://localhost:3000"
  : "https://dashboard.tuneurl.com"; //'https://dev7628.d722rv280a3p6.amplifyapp.com';
//const redirectURI = 'http://localhost:3000';
const cognitoAuthPathTemplate =
  "https://{#0#}.auth.{#1#}.amazoncognito.com/login?response_type=token&client_id={#2#}&redirect_uri={#3#}";
